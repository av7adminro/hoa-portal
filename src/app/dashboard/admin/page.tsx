  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'payments':
        return (
          <div className="backdrop-blur-2xl bg-white/10 rounded-2xl p-6 border border-white/20">
            <h3 className="text-xl font-bold text-gray-800 mb-6">Gestionare plăți</h3>
            <p className="text-gray-600 mb-6">Administrează toate plățile și facturile asociației</p>
            <Link
              href="/payments"
      ...
      case 'notifications':
        return (
          <div className="backdrop-blur-2xl bg-white/10 rounded-2xl p-6 border border-white/20">
            <h3 className="text-xl font-bold text-gray-800 mb-6">Gestionare notificări</h3>
            <p className="text-gray-600 mb-6">Trimite și administrează notificările pentru locatari</p>
            <Link
              href="/notifications"
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium hover:scale-105 transition-all duration-300"
            >
