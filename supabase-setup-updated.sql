-- HOA Portal Database Setup - Updated Version
-- This script creates the missing tables and ensures compatibility with existing structure
...
INSERT INTO public.associations (id, name, address, registration_number, tax_number, president_name)
VALUES (
  gen_random_uuid(),
